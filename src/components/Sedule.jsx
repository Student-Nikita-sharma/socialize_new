...
function Sedule() {
  ...
  const [isPickerVisiable, setPickerVisiable] = useState("false");
...
<div>
      <i className="smili_emoji" onClick={handleClick}>
        <FontAwesomeIcon icon={faSmileWink} />
      </i>
      {showText && <p> Windows Key+keyboard shortcut.</p>}
    </div>
            ...
            <div className="text-center py-3">
              <button className="py-2 px-16 text-white bg-[#377DFF]">
                Schedule
              </button>
            </div>
          </div>
